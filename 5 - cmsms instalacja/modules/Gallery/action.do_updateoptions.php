...
if (ctype_digit($params['imagewebpquality']) && $params['imagewebpquality'] <= 100)
	$this->SetPreference('imagewebpquality', $params['imagewebpquality']);
if (ctype_digit($params['thumbwebpquality']) && $params['thumbwebpquality'] <= 100)
	$this->SetPreference('thumbwebpquality', $params['thumbwebpquality']);
