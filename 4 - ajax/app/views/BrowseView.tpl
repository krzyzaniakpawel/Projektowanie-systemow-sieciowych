...
<form id="search-form" method="post" onsubmit="ajaxPostForm('search-form', '{$conf->action_root}search/1', 'series-grid-result'); return false;"
class="w3-padding-32">
...
<div id="series-grid-result">
  {include file="BrowseViewPart.tpl"}
</div>
...
{* {block name=footer}
<div id="page-bar">
  {include file="pagination-bar.tpl"}
</div>
{/block} *}