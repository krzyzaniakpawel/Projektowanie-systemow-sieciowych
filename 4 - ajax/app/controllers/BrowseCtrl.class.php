...
class BrowseCtrl {
    ...
    public function action_search() {
        $this->args = new Args(
            ...
            ParamUtils::getFromRequest("format", false),
        ...
        $this->generateView("BrowseViewPart.tpl");
    }
    ...
    private function getCover() {
        if (isset($this->records)) {
            ...
            //     if (str_contains($_SERVER['REQUEST_URI'], "browse") || str_contains($_SERVER['REQUEST_URI'], "search")) {
            //         $dir = "../img/covers/";
            ...
            foreach ($this->records as &$record) {
                $id = $record["id"];
                $path = App::getConf()->root_path."\public\img\covers\\".$id;
                $dir = App::getConf()->app_root."/img/covers/";
                $record["img_path"] = match (true) {
                    file_exists($path.".jpg") => $dir.$id.".jpg",
                    file_exists($path.".png") => $dir.$id.".png",
                    default => $dir.'none.jpg'
                };
            }
        }
    ...
    public function action_browse() {
        ...
        $this->generateView("BrowseView.tpl");
    }

    public function generateView($template_file_name) {
        $this->getCover();
        ...
        App::getSmarty()->display($template_file_name);
    }
}
